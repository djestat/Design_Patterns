...
extension SearchGroupViewController {
    ...
    private func getGroups(by search: String) {
        AlamofireServiceProxy.instance.searchGroups(search: search, delegate: self)
    }
    
    private func leaveGroup(by gid: Int) {
        AlamofireServiceProxy.instance.leaveGroup(gid: gid, delegate: self)
    }
    
    private func joinGroup(by gid: Int) {
        AlamofireServiceProxy.instance.joinGroup(gid: gid, delegate: self)
    }
}
